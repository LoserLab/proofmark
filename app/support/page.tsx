      ...
      <section className="max-w-4xl mx-auto px-6 pt-32 pb-24">
        ...
        <div className="mt-8 bg-[var(--white)] rounded-lg border p-6 shadow-sm" style={{ borderColor: 'rgba(90, 120, 99, 0.25)' }}>
          ...
          <p className="text-sm text-[var(--text)] mb-2">
            Email: <span className="font-medium">support@draftlock.com</span>
          </p>
        ...
        <div className="mt-12 space-y-8">
          <div>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-base font-medium text-[var(--text)] mb-2">What does DraftLock do?</h3>
                <p className="text-sm text-[var(--muted)] leading-relaxed">
                  DraftLock creates timestamped authorship records and generates evidence packs for creative work. It tracks version history, creates cryptographic fingerprints, and organizes documentation you can archive or reference later.
                </p>
              </div>

              <div>
                <h3 className="text-base font-medium text-[var(--text)] mb-2">What doesn&apos;t DraftLock do?</h3>
                <p className="text-sm text-[var(--muted)] leading-relaxed">
                  DraftLock does not provide legal advice, notarization, or enforcement. It does not send messages, monitor conversations, or determine legal outcomes. DraftLock creates neutral documentation and proof of existence only.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-[var(--muted)] leading-relaxed">
                  DraftLock uses secure storage providers to store files and metadata. Access controls limit exposure. Data is retained while your account remains active or as needed to provide the service. You may remove content at your discretion.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-[var(--muted)] leading-relaxed">
                  Each time you update your work, you can record a new version. DraftLock links versions together so the evolution is easy to follow. This creates a clean lineage without forcing you to change how you write or collaborate.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-[var(--muted)] leading-relaxed">
                  DraftLock is not a law firm and does not provide legal advice. Use of the service does not create an attorney-client relationship. Evidence packets are informational and organizational in nature. DraftLock helps creators maintain records of their work. It does not replace copyright registration or legal counsel.
                </p>
              </div>
            </div>
          </div>
